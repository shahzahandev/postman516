    ...
    return (
        <div className='bg-[url(./assets/home11.webp)] bg-center bg-cover w-full h-screen flex justify-center items-center'>
            <div className='bg-linear-to-r/srgb from-[#f36481] to-[hsl(18,80%,67%)] py-[20px] md:py-[30px] px-[30px] md:px-[80px] rounded-[10px] text-center border-4 border-[#e39b9b]'>
                ...
                <Link to="/">
                    <button onClick={handleStart} className='text-[14px] md:text-2xl font-semibold text-primary bg-gray-500 px-[30px] md:px-[50px] py-[8px] md:py-[10px] rounded-[20px] cursor-pointer capitalize mt-[10px] md:mt-[20px] border-none transition-all duration-300 hover:bg-gray-700 hover:text-white/80'>
                        {
                            start ?
                                (<DNA
                                    visible={true}
