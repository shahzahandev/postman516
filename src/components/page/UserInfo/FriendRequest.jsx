...
const handleAcceptRequest = (acceptInfo) => {
    //   console.log("Accepted", acceptInfo);
       set(ref(db, "AcceptedFriend/" + acceptInfo.reciverName),{
            newFriend: acceptInfo.reciverName,
            accepting: acceptInfo.senderName,
       });      
}
                        ...
                        <div className='flex justify-between items-center mt-[10px] md:mt-[18px] border-b-2 border-bg-black/50 pb-3 md:px-[20px]'>
                            <div className='flex justify-between items-center space-x-[14px]'>
                                ...
                                <div className='flex flex-col'>
                                    <h2 className='font-third font-semibold text-[12px] md:text-[18px] text-secondary'>{user.reciverName}</h2>
                            ...
                            <div>
                                <button onClick={() => handleAcceptRequest(user)}
                                 className='font-third font-semibold text-[14px] md:text-[20px] text-[#FFFFFF] py-[2px] px-[8px] bg-secondary rounded-[10px] transition-all duration-300 cursor-pointer hover:bg-green-700'>Accept</button>
                            </div>
                        </div>
                    ))
                }
