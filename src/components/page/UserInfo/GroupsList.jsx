...
const GroupsList = () => {
    ...
    return (
        <div className='bg-linear-to-r/srgb from-[#b5ee65] to-[#c5f37c] py-2 px-3 md:px-10 shadow-[0px_4px_4px_0px] shadow-[#000000]/25  rounded-[20px] h-[451px] overflow-y-scroll pt-[10px] md:pt-[20px]'>
            <ToastContainer
                position="top-center"
                autoClose={2000}
                    ...
                    <div>
                        {
                            show ?
                                <button
                                    onClick={() => setShow(!show)} className='font-third font-semibold text-[10px] md:text-[12px] text-[#FFFFFF] py-[2px] px-2 md:px-[8px] bg-secondary rounded-[10px] transition-all duration-300 cursor-pointer hover:bg-[#75a107]'>Create Group</button>
                                :
                              "" 
                        }
                    </div>
            ...
            <div className=''>
                {
                    show
                            ...
                            groupList.map((user) => (
                                ...
                                <div className='flex justify-between items-center space-x-[14px]'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <h3 className='font-third font-medium text-[11px] md:text-[10px] text-[#4D4D4D]/75'>{user.groupTagName}</h3>
                                    </div>
                                </div>
                                <div>
                                    <button className='font-third font-semibold text-[14px] md:text-[16px] text-[#FFFFFF] py-[2px] px-2 md:px-[8px] bg-secondary rounded-[10px] transition-all duration-300 cursor-pointer hover:bg-[#75a107]'>Join</button>
                                </div>
                            </div>
                            ))
                           }
                        ...
                        :
                        <div className='font-medium font-primary bg-primary  absolute  md:top-[60px] left-[100px] md:left-[280px] mt-6 w-[300px] md:w-[1235px] pt-[50px] md:pt-[100px] pb-[50px] md:pb-[100px] rounded-2xl'>
                            <div className='px-2 py-2  flex flex-col space-y-[20px] md:space-y-[30px] items-center'>
                                ...
                                <button
                                    onClick={() => setShow(!show)} className='w-[250px] md:w-[1035px]  font-third font-semibold text-[12px] md:text-[20px] text-[#FFFFFF] px-2 md:px-[50px] py-2 md:py-[20px] bg-linear-to-r/srgb from-[#ec5a92] to-[#ee9068] rounded-[50px] transition-all duration-300 cursor-pointe'>Cancel</button>
                            </div>
                        </div>
                }
            </div>
